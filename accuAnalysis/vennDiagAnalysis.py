...
from accuAnalysis import loadfiles
...
set1006 = set(loadfiles.list1006)
set588342 = set(loadfiles.list588342)
set411 = set(loadfiles.list411)
...
twiceHitNotin411 = bothin1006and588342-set(loadfiles.listAll411)
twiceHitNotin1006 = bothin411and588342-set(loadfiles.listAll1006)
falsePosin1006 = onlyin1006&set(loadfiles.listAll411)
#Shall we consider the ones in only 1006 to be a false positive??, in that case::
#falsePosin1006 = onlyin1006
inactivein1006 = set(loadfiles.listAll1006) - set1006
inactivein411 = set(loadfiles.listAll411) - set411
...
if __name__ == "__main__":
    ...
    venn3([set(loadfiles.list1006), set(loadfiles.list588342), set(loadfiles.list411)], ('AID1006', 'AID588342', 'AID411'))
    plt.show()
